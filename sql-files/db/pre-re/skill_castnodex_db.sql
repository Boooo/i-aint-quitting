DROP TABLE IF EXISTS `skill_castnodex_db`;
CREATE TABLE `skill_castnodex_db` (
	`SkillID` int(11) unsigned NOT NULL default '0',
	`Cast` tinyint(1) unsigned NOT NULL default '0',
	`Delay` tinyint(1) unsigned,
	PRIMARY KEY (`SkillID`)
) ENGINE=MyISAM;
...
REPLACE INTO `skill_castnodex_db` VALUES (366,1,NULL);
...
#REPLACE INTO `skill_castnodex_db` VALUES (2537,0,7);
